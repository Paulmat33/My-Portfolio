    ...
    <div className='pt-16 pb-16 bg-[#050709]'>
      ...
      <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-20'>
        ...
        <div>
          ...
          <p className='text-gray-500 text-base mt-6'>{aboutInfo.description}</p>
          <div className='mt-8'>
        ...
        <div className='grid grid-cols-2 gap-16 items-center lg:mx-auto'>
          <div>
            ...
            <p className='text-base sm:tex-lg text-gray-400 text-center'>Satisfied Customers</p>
          </div>
          <div>
            ...
            <p className='text-base sm:tex-lg text-gray-400 text-center'>years Experience</p>
          </div>
          <div>
            ...
            <p className='text-base sm:tex-lg text-gray-400 text-center'>Completed Projects</p>
          </div>
          <div>
            ...
            <p className='text-base sm:tex-lg text-gray-400 text-center'>Website Launched</p>
          </div>
        </div>
      </div>
    </div>
